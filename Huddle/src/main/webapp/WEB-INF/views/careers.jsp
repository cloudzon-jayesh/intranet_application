      ...
      <div class="content-container">
        <div class="row outer-title">
          <div class="large-12 medium-12 small-12 columns">
           <p>Join our team<br><span>job opportunities</span></p>
          </div>
           <hr>
        </div>
        <div class="row career-container"> 
          <ul class="small-block-grid-2 medium-block-grid-3 large-block-grid-4">
            <li><a href="#" data-reveal-id="firstModal"><div>java</div></a></li>
            <li><a href="#"><div>.net</div></a></li>
            <li><a href="#"><div>ios</div></a></li>
            <li><a href="#"><div>ui/ux</div></a></li>
    ...
    <footer>
     ...
     <div class="row" id="bottom-footer">
      <div class="large-12 medium-12 small-12 columns">
        ...
        <!-- Reveal Modals begin -->
    <div id="firstModal" class="reveal-modal full" data-reveal>
      <h2>jobs title.</h2>
      <p>description and other materials</p>
      <a href="#" data-reveal-id="secondModal" class="secondary button">Apply</a></p>
      <a class="close-reveal-modal">&#215;</a>
    </div>

    <div id="secondModal" class="reveal-modal full" data-reveal>
      <h2>apply for title </h2>
      <p>contact form , txt box and upload file.</p>
      <a class="close-reveal-modal">&#215;</a>
    </div>
