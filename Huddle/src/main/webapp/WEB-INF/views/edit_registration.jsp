...
<html class="no-js" lang="en">
  <head>
    ...
    <title>CloudZon.huddle | Edit Employee</title>
...
<script src="js/view/EditEmployeeList.js"></script>
...
<script type="text/template" id="main_template">
	<div class="row login-container">
		<div class="large-7  medium-12 small-12 columns input-block">
				...
				<div class="input-left-main">
					...
					<div class="input-main">
						...
						<div class="control-group email">
							<input type="text" id="email" maxlength="40" name="email" readonly="readonly">
							<span class="help-inline"></span>
						</div>
					</div>
					<div class="input-main">
						...
						<div class="control-group password">
							<input type="password" maxlength="40" id="password"
								name="password" readonly="readonly"> <span class="help-inline"></span>
						</div>
					</div>
					<div class="input-main">
						...
						<div class="control-group retypePassword">
							<input type="password" maxlength="40" id="retypePassword"
								name="retypePassword" readonly="readonly"> <span class="help-inline"></span>
						</div>
					</div>
					<div class="input-main">
			...
			<script>
				var editEmployeeList = new EditEmployeeList({
					el : $("#main-container"),
				});
				editEmployeeList.render();
