...
<html class="no-js" lang="en">
  <head>
    ...
    <title>CloudZon.huddle | Company</title>
      ...
      <div class="content-container">
        <div class="row outer-title">
          <div class="large-12 medium-12 small-12 columns">
           <p>about us<br><span>cloudZon culture</span></p>
          </div>
           <hr>
        </div>
        <div class="row"><div class="large-12 medium-12 small-12 columns"><p>information goes here. design/layout still in progress.</p></div></div>
      </div>
    </div>
    <footer>
